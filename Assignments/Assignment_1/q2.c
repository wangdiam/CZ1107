...
{
	// add your code here
	ListNode *currNodell1 = ll1->head;
	ListNode *currNodell2 = ll2->head;
	while (currNodell1 != NULL) {
			if (currNodell2 != NULL) {
				ListNode *temp = currNodell1->next;
				currNodell1->next = currNodell2;
				currNodell2 = currNodell2->next;
				ll2->head = currNodell2;
				currNodell1->next->next = temp;
				currNodell1 = currNodell1->next->next;
			} else {
				break;
			}
	}
