...
void removeDuplicatesSortedLL(LinkedList *ll)
{
	...
	while (currNode != NULL && currNode->next != NULL) {
		while (currNode->next != NULL && currNode->next->item == currNode->item) {
			ListNode *temp = currNode->next;
			if (currNode != NULL && currNode->next != NULL) currNode->next = currNode->next->next;
			free(temp);
		}
		if (currNode != NULL) currNode = currNode->next;
	}
}
//1 1 1 2 1 3 1 4 1 4 1 4 1 5 1 6 1 6
///////////////////////////////////////////////////////////////////////////////////
